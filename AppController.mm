...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
    ...
    bannerView = [[ADBannerView alloc] initWithFrame:CGRectMake(0, 0, 320, 10)];
    bannerView.currentContentSizeIdentifier = ADBannerContentSizeIdentifierPortrait;
    [__glView addSubview:bannerView];
    bannerView.delegate = self;
    [__glView bringSubviewToFront:bannerView];
...
//    cocos2d::CCScene * scene = dir->getRunningScene();
//    cocos2d::CCArray * array = scene->getChildren();
//    
//    if ((array->count())>0) {
//        HelloWorld *layer = (HelloWorld *)array->objectAtIndex(0);
//        layer->actionPauseAndResum();
//    }else{
//        cocos2d::CCDirector::sharedDirector()->pause();
//    }
}
